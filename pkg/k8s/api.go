...
func (kubeAPI *KubernetesAPI) GetPodsByNamespace(ctx context.Context, client rest.HTTPClient, namespace string) ([]v1.Pod, error) {
	return kubeAPI.getPods(ctx, client, "/api/v1/namespaces/"+namespace+"/pods")
}

func (kubeAPI *KubernetesAPI) getPods(ctx context.Context, client rest.HTTPClient, path string) ([]v1.Pod, error) {
